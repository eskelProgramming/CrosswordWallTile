...
namespace CrosswordWallTile.Data.Migrations
{
    ...
    [Migration("20241202185430_RefactoredStain")]
    partial class RefactoredStain
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CrosswordWallTile.Models.Frame", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CrosswordWallTile.Models.Stain", b =>
                {
                    ...
                    b.PrimitiveCollection<string>("AllowedFontColors")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("CrosswordWallTile.Models.Tile", b =>
                {
                    b.HasOne("CrosswordWallTile.Models.Stain", "CurrentStain")
                        .WithMany()
                        .HasForeignKey("CurrentStainId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CurrentStain");
                });
